...
-- 11. PROJECT_COMMENTS
INSERT INTO project_comments (id, text, project_id, author_id, is_active, created_at, updated_at, projectCommentNumber) VALUES
(1, 'Projeto muito bem estruturado! O código está bem organizado e documentado. Parabéns!', 1, 4, true, '2024-01-26 15:00:00', '2024-01-26 15:00:00', 1),
(2, 'Gostei muito da interface do e-commerce. Como você implementou o sistema de pagamentos?', 2, 3, true, '2024-02-02 17:30:00', '2024-02-02 17:30:00', 1),
(3, 'A API está muito bem documentada. Seria possível adicionar testes unitários?', 3, 2, true, '2024-02-11 11:30:00', '2024-02-11 11:30:00', 1),
(4, 'Dashboard ficou incrível! Os gráficos estão muito informativos. Qual biblioteca usou?', 4, 1, true, '2024-02-16 10:15:00', '2024-02-16 10:15:00', 1),
(5, 'App de fitness tem um design muito clean. Pretende adicionar integração com wearables?', 5, 4, true, '2024-02-19 12:45:00', '2024-02-19 12:45:00', 1);
