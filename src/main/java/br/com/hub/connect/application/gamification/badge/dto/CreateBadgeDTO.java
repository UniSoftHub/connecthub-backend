...
public record CreateBadgeDTO(
        ...
        @NotBlank(message = "Image Url is required") @Size(max = 255, message = "Image URL must not exceed 255 characters") String imageUrl,

        @NotBlank(message = "Criteria is required") @Size(min = 10, max = 500, message = "Criteria must be between 10 and 500 characters") String criteria) {
}